...
export default function Player() {
  ...
  return (
    ...
    {state.slowMotion && <Image alt="" source={{uri: 'https://media0.giphy.com/media/aJpQEYoD8yLE4/source.gif'}} style={{width: '100%', height: '100%',opacity: 0.8}} ImageResizeMode="cover"/> }
    </View>
  );
}
